...
\]
```{r}
xBD_n5 <- rbinom(n=5, size=5, prob=2/3)
xBD_n5
mean(xBD_n5) #3.2
var(xBD_n5) # 0.7

xBD_n15 <- rbinom(n=15, size=5, prob=2/3)
xBD_n15
mean(xBD_n15) # 3.4
var(xBD_n15) # 1.2

xBD_n25 <- rbinom(n=25, size=5, prob=2/3)
xBD_n25
mean(xBD_n25) #3.360
var(xBD_n25) # 1.157

xBD_n1000 <- rbinom(n=1000, size=5, prob=2/3)
xBD_n1000
mean(xBD_n1000) # 3.361
var(xBD_n1000) # 1.056

xBD_n100000 <- rbinom(n=100000, size=5, prob=2/3)
xBD_n100000
mean(xBD_n100000) # 3.335
var(xBD_n100000) # 1.109

# Why my variance does not go to 2 and mean doesn't go to 6?
...
Observation: with large sample size n, the mean and variance approaches population mean and variance.
...
\]
```{r}
xNorm_n5 <- rnorm(n=5, mean=2, sd = 1)
xNorm_n5
mean(xNorm_n5) 
var(xNorm_n5) 

xNorm_n15 <- rnorm(n=15, mean=2, sd = 1)
xNorm_n15
mean(xNorm_n15) 
var(xNorm_n15) 

xNorm_n25 <- rnorm(n=25, mean=2, sd = 1)
xNorm_n25
mean(xNorm_n25) 
var(xNorm_n25) 

xNorm_n1000 <- rnorm(n=1000, mean=2, sd = 1)
xNorm_n1000
mean(xNorm_n1000) 
var(xNorm_n1000)
